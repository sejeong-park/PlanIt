...
const getTripAttraction = () => {
  listTripAttraction(
    ...
    (response) => {
      ...
      //   console.log("value : ", searchList.value);
...
// const getLoadTripAttraction = () => {
//   mockParam.value.sidoCode = 1;
//   mockParam.value.gugun = 1;
//   listTripAttraction(
//     mockParam.value,
//     (response) => {
//       //   console.log(param.value);
                ...
                <div class="card-btn">
                  ...
                  <a-tooltip title="상세 정보 보기">
                    <a-button
                      ...
                      shape="circle"
                      size="20"
                      @click.stop.prevent="showDetailInfoModal(item, index)"
                    >
                      <InfoCircleOutlined />
                    </a-button>
                  </a-tooltip>
                  ...
                  <a-tooltip title="일정에 추가하기">
                    <a-button
                      ...
                      shape="circle"
                      size="20"
                      @click="addAttractionToDail(item)"
                    >
                      <PlusCircleOutlined />
                    </a-button>
                  </a-tooltip>
